...
async def record_order_result(body: OrderResultRequest) -> OrderResultResponse:
    ...
    try:
        async with async_session_factory() as session:
            ...
            # Fill hesabı callback anındaki canlı hesaptan DEĞİL, OrderLog'a
            # emir gönderilirken yazılan sabit account_ref'ten alınır (Fix #1,
            # record_fill_delta içinde row.account_ref).
