...
_RULES = (
    ("KILL_SWITCH", ("kill switch",)), ("CUTOFF", ("cutoff", "trading cutoff")),
    ...
    ("MARKET_REGIME", ("market regime", "rejim")), ("NATR_HIGH", ("natr",)),
    ...
    ("DEMO_NOT_ENABLED", ("demo",)), ("REAL_NOT_ENABLED", ("real live", "real")),
    ...
    ("DUPLICATE_REQUEST", ("duplicate",)), ("COOLDOWN", ("cooldown",)),
)
