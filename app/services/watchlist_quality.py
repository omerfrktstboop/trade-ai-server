...
def calculate_quality(item: dict[str, Any], ask_bid_ratio: float | None) -> dict[str, Any]:
    ...
    news=50; risk=75
    return {"quality":round(momentum*.3+volume_score*.25+depth*.25+news*.1+risk*.1,2),"momentum":momentum,"volume":volume_score,"depth":depth,"news":news,"risk":risk,"askBidRatio":ask_bid_ratio}
