...
def make_snapshot_payload(symbol: str, **overrides: Any) -> dict[str, Any]:
    ...
    payload: dict[str, Any] = {
        "marketDataContractVersion": "matriks-market-data-v2",
        "instrumentType": "EQUITY",
        "requestedTimeframe": "MIN5",
        "actualBarPeriod": "MIN5",
        "actualBarPeriodSeconds": 300,
        "barPeriodSource": "BarDataEventArgs.PeriodInfo",
        "timeframeMismatch": False,
        "timeframe": "MIN5",
        "indicatorPeriod": "MIN5",
        "indicatorPeriodSeconds": 300,
        "lastPrice": 71.5,
        "open": 71.0,
        "high": 72.0,
        "low": 70.8,
        ...
        "depthAgeSeconds": 1.0,
        "volume": 12000.0,
        "volumeSemantic": "BAR_VOLUME",
        "barVolume": 12000.0,
        "barVolumeSource": "BarData.BarData.Volume",
        "barVolumeUnit": "LOTS",
        "barVolumeReliable": True,
        "totalVol": 858_000_000.0,
        "sessionTurnoverTl": 858_000_000.0,
        "totalVolSemantic": "CUMULATIVE_SESSION_TURNOVER_TL",
        "totalVolSource": "SymbolUpdateField.TotalVol",
        "totalVolUnit": "TRY",
        "totalVolReliable": True,
        "barClosed": False,
        "barIsNew": False,
        "barDataIndex": 123,
        "rsi": 55.0,
